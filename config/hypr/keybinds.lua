...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("qs -p /home/emo/Programs/HyprCade/config/quickshell/HyprCade ipc call launcher toggle"))
hl.bind(mainMod .. " + P", hl.dsp.window.pseudo())
hl.bind(mainMod .. " + J", hl.dsp.layout("togglesplit"))    -- dwindle only
hl.bind(mainMod .. " + F", hl.dsp.window.fullscreen({ action = "toggle" }))
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("hyprlock"))
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("zen-browser"))
hl.bind(mainMod .. " + X", hl.dsp.exec_cmd("hyprshot -m output --clipboard-only -m region"))
...
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd("qs -p /home/emo/Programs/HyprCade/config/quickshell/HyprCade ipc call visualdeck toggle"))
...
for i = 1, 10 do
    ...
    hl.bind("XF86MonBrightnessUp",  hl.dsp.exec_cmd("/home/emo/Programs/HyprCade/scripts/brightness-osd.sh up"),    { locked = true, repeating = true})
    hl.bind("XF86MonBrightnessDown",hl.dsp.exec_cmd("/home/emo/Programs/HyprCade/scripts/brightness-osd.sh down"),  { locked = true, repeating = true})
